...
PhantomX.plot([0 pi/2 pi/2 pi/2])
...
clc
MTH1 = [ [0.4945   -0.8575   -0.1420    2.2536],
         [-0.8242   -0.5145    0.2368   -3.7563], 
         [-0.2761   -0.0000   -0.9611   -5.4777], 
         [0         0         0    1.0000]];


PhantomX.ikine(MTH1,'mask',[1 1 1 1 0 0])
